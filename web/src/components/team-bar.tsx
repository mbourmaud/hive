...
function livenessRing(liveness: string) {
  switch (liveness) {
    case "working": return "ring-2 ring-white/30 ring-offset-1 ring-offset-card";
    case "completed": return "ring-2 ring-white/30 ring-offset-1 ring-offset-card";
    case "dead": return "ring-2 ring-destructive/40 ring-offset-1 ring-offset-card";
    default: return "";
  }
}
