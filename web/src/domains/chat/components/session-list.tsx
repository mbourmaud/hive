...
import { type DateGroup, groupSessionsByDate, relativeTime, type SessionMeta } from "../queries";
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 min-w-0">
        <div className={cn("w-1.5 h-1.5 rounded-full shrink-0", statusDotClass(session.status))} />
