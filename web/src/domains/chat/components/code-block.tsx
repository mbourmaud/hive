...
export function CodeBlock({
  ...
  return (
    <div data-component="code-block" className={cn("group", className)}>
      {resolvedLang !== "text" && <span data-slot="code-block-lang">{resolvedLang}</span>}
      ...
      <div data-slot="code-block-scroll" style={{ maxHeight: `${maxHeight}px` }}>
        {showLineNumbers ? (
