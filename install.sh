...
echo -e "  ${CYAN}3.${RESET} Create a plan with ${CYAN}/hive:plan${RESET} in Claude Code"
echo -e "  ${CYAN}4.${RESET} hive start my-drone"
echo -e "  ${CYAN}5.${RESET} Monitor progress with ${CYAN}hive monitor${RESET}"
echo ""
